...
import nftDinoImage from "../assets/Leo's Trex.png";

const features = [
  {
    name: "AI Generated NFTs.",
    description: "I am not an artist.",
    icon: FireIcon,
  },
  {
    name: "Hand designed Smart Contracts.",
    description: "I coded everything on this site by hand.",
    icon: FireIcon,
  },
  {
    name: "More to come...",
    description: "This project is just the beginning",
    icon: FireIcon,
  },
];
  ...
  return (
    <div className="bg-[#1a1919]">
      <div className="mx-auto max-w-7xl">
        <div className="relative isolate overflow-hidden bg-[#1a1919] py-20 px-6 sm:rounded-3xl sm:py-24 sm:px-10 lg:py-24 xl:px-24">
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-y-16 gap-x-8 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-center lg:gap-y-0">
            <div className="lg:row-start-2 lg:max-w-md">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-300">
                Best NFTs on the market. The image is another feature of the
                collection.
              </p>
            </div>
            <img
                ...
                {features.map((feature) => (
                  <div key={feature.name} className="relative">
                    <dt className="ml-9 inline-block font-semibold text-white">
                      <feature.icon
                        className="absolute top-1 left-1 h-5 w-5 text-gray-700"
                        aria-hidden="true"
                      />
                      {feature.name}
                    </dt>{" "}
